        ...
        <div class="row hide-on-med-and-down">
          <div class="col s12">
            <ul class="tabs teal darken-3">
              <li class="tab col s1"> <a class="active white-text" target="_self" href="catalogo.php">Home</a> </li>
              <li class="tab col s1"> <a class="white-text" target="_self" href="loja.php">Loja</a> </li>
              <li class="tab col s1"> <a class="white-text" target="_self" href="feed.php">Feed</a> </li>
              <li class="tab col s1"> <a class="white-text" target="_self" href="planos.php">Planos</a> </li>
              <li class="tab col s1"> <a class="white-text" target="_self" href="aulas.php">Aulas</a> </li>
              <li class="tab col s1"> <a class="white-text" target="_self" href="perfil.php">Meu perfil</a> </li>
            </ul>
          </div>
        </div>
